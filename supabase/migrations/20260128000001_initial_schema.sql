...
-- Example companies (comment out in production)
-- INSERT INTO companies (name, symbol, sector, exchange, currency) VALUES
-- ('Apple Inc.', 'AAPL', 'Technology', 'NASDAQ', 'USD'),
-- ('Microsoft Corporation', 'MSFT', 'Technology', 'NASDAQ', 'USD'),
-- ('Tesla, Inc.', 'TSLA', 'Automotive', 'NASDAQ', 'USD');
